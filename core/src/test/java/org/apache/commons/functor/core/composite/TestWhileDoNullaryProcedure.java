...
public class TestWhileDoNullaryProcedure extends BaseFunctorTest {
	...
	public NullaryProcedure mockNullaryProcedure1(List<Object> list) {
		List<Object> mockFieldVariableList;
		NullaryProcedure mockInstance = mock(NullaryProcedure.class);
		mockFieldVariableList = list;
		doAnswer((stubInvo) -> {
			mockFieldVariableList.remove(0);
			return null;
	...
	public void testLoopWithAction() throws Exception {
		...
		NullaryProcedure action = mockNullaryProcedure1(list);
		...
		list = getList();
		action = mockNullaryProcedure1(list);
